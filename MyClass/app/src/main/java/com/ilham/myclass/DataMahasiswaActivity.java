...
import com.ilham.myclass.helper.DataHelper;
...
public class DataMahasiswaActivity extends AppCompatActivity {
    ...
    DataHelper dbcenter;
    public static DataMahasiswaActivity DM;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent inte = new Intent(DataMahasiswaActivity.this, InputDataActivity.class);
                startActivity(inte);
            }
        });
        ...
        ListView01.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView arg0, View arg1, int arg2, long arg3) {
                ...
                AlertDialog.Builder builder = new
                        AlertDialog.Builder(DataMahasiswaActivity.this);
